...
type Props = {
  ...
  interactive?: boolean;
  printVariant?: "student" | "answerKey";
};
            ...
            <div key={question.id} className="section-print-question bg-white rounded-xl shadow p-6">
              ...
              <div className="section-print-answer-list space-y-3 mt-4">
                {question.choices.map((choice, choiceIndex) => {
                  ...
                  const answerChoiceIndex = question.answer
                    ? question.choices.findIndex((answerChoice) => answerChoice === question.answer)
                    : -1;
                  const correctChoiceIndex = answerChoiceIndex >= 0 ? answerChoiceIndex : question.answerIndex;
                  const isCorrectPrintChoice = printVariant === "answerKey" && correctChoiceIndex === choiceIndex;
