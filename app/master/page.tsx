...
export default function MasterPage() {
  ...
  const [expandedOversightGroupIds] = useState<string[]>([]);
  ...
  const [mExpandedGroupIds] = useState<string[]>([]);
